...
BEGIN
    ...
    IF v_count = 0 THEN
        EXECUTE IMMEDIATE 'CREATE SEQUENCE DEITY_TYPE_SEQ START WITH 1000 INCREMENT BY 1 NOCACHE';
    END IF;
    ...
    IF v_count = 0 THEN
        EXECUTE IMMEDIATE 'CREATE SEQUENCE DEITY_SEQ START WITH 1000 INCREMENT BY 1 NOCACHE';
    END IF;
